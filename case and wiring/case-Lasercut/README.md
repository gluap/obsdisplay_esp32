...
<figcaption style="text-align:center">Plywood parts laid out</figcatpion>
</figure>
...
3. When all parts are glued, use packing tape or similar to affix the parts against each other with a bit of pressure.
    <figure><img src="../../media/case_glued_drying.jpg" style="width:800px"><figcaption style="text-align:center">Case glued and secured with packing tape.</figcaption></figure>
...
5. Add strain relief using hot glue to ensure the cables on the back of the display as well as the one on the USB Socket don't get twisted too much during further assembly.
   <figure><img src="../../media/strainrelief.jpg" style="width:800px"><figcaption style="text-align:center">Case with hot-glue-strain-relief and ESP32 glued in</figcaption></figure>
...
3. Stick the JST-XH-PCB connectors on the PCB pins as shown.
    <figure><img src="../../media/connectors_on_esp.jpg" style="width:600px"><figcaption style="text-align:center">JST Connectors on ESP. <B>pay attention to the direction, for both connectors, the gaps point inwards w.r.t. the ESP.</B></figcaption></figure>
4. Crimp female crimps onto the LED matrix cable. Stick them in a 3-pin connector [female] in the order matching the three pin connector on the ESP. (either to the one coming out of the LED matrix or to the small pigtail cable that came with the Display).
    <figure><img src="../../media/pigtail_crimp.jpg" style="width:800px"><figcaption style="text-align:center">JST connector connected to to the pigtail that came with the LED matrix.</figcaption><figure>
...
5. Wire the buttons like in the diagram (lines that do not touch are not connected). Solder the contacts to the buttons and use crimp contacts at the other end of the wire.
    <figure><img src="../../media/button_wiring_diagram.jpg" style="width:300px"><figcaption style="text-align:center">Wiring diagram for the buttons.</figcaption><figure>
